...
## Project Structure
    ...
    ├── broken_butterfly_de_68766  # Django project configurations
...
1. Clone this repo and `cd broken_butterfly_de_68766`
...
2. Clone this repo and `cd broken_butterfly_de_68766`
